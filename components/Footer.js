...
function Footer() {
  ...
  <div className="container px-6 pt-6 p-">
    ...
    <div className="grid lg:grid-cols-4 md:grid-cols-2">
      <div className="mb-6">
        <h5 className="uppercase font-bold mb-2.5">Store</h5>

        <ul className="list-none mb-0">
        <li>
            <a href="#!" className="text-white">Herren</a>
          </li>
          <li>
            <a href="#!" className="text-white">Damen</a>
          </li>
          <li>
            <a href="#!" className="text-white">Kind</a>
          </li>
          <li>
            <a href="#!" className="text-white">Accessories</a>
          </li>
        </ul>
      </div>
      ...
      <div className="mb-6">
        ...
        <ul className="list-none mb-0">
          ...
          <li>
            <a href="#!" className="text-white">Find Store</a>
          </li>
          <li>
            <a href="#!" className="text-white">Gift Cart</a>
          </li>
          <li>
  ...
  <div className="text-center p-4">
    © 2022 Copyright:
    <a className="text-white" href="https://tailwind-elements.com/"> Amirrroff</a>
  </div>
</footer>
    </div>
  )
