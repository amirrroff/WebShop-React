...
function Navbar() {
  ...
  <div className="sm:hidden" id="mobile-menu">
    <div className="px-2 pt-2 pb-3 space-y-1">
        <Link href="/"><a className="  text-white hover:bg-gray-700 px-3 py-2 rounded-md text-base font-medium block" aria-current="page">Home</a></Link>
        <Link href="/Contact"><a className="text-gray-300 hover:bg-gray-700 hover:text-white px-3 py-2 block rounded-md text-base  font-medium">Contact</a></Link>
        <Link href="/shop"><a className="text-gray-300 hover:bg-gray-700 hover:text-white px-3 py-2 block rounded-md text-base font-medium">Shop</a></Link>
    </div>
  </div>
